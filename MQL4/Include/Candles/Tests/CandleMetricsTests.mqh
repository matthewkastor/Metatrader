...
//|                                                                  |
//+------------------------------------------------------------------+
class CandleMetricsTests : public BaseTestSuite
  {
public:
   void              CandleMetricsTests();
   void              RunAllTests();
...
//|                                                                  |
//+------------------------------------------------------------------+
void CandleMetricsTests::CandleMetricsTests()
  {
   this.unitTest.Name="CandleMetricsTests";
  }
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
